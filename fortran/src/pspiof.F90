...
module pspiof_m
  ...
  integer(c_int), parameter, public :: PSPIO_STRLEN_TITLE = 256
  ...
  integer(c_int), parameter, public :: PSPIO_FMT_ATOM = 1
  integer(c_int), parameter, public :: PSPIO_FMT_FHI98PP = 2
  integer(c_int), parameter, public :: PSPIO_FMT_OCTOPUS_HGH = 3
  integer(c_int), parameter, public :: PSPIO_FMT_SIESTA = 4
  integer(c_int), parameter, public :: PSPIO_FMT_UPF = 5
  integer(c_int), parameter, public :: PSPIO_FMT_XML = 6
  integer(c_int), parameter, public :: PSPIO_FMT_ABINIT_1 = 11
  integer(c_int), parameter, public :: PSPIO_FMT_ABINIT_2 = 12
  integer(c_int), parameter, public :: PSPIO_FMT_ABINIT_3 = 13
  integer(c_int), parameter, public :: PSPIO_FMT_ABINIT_4 = 14
  integer(c_int), parameter, public :: PSPIO_FMT_ABINIT_5 = 15
  integer(c_int), parameter, public :: PSPIO_FMT_ABINIT_6 = 16
  integer(c_int), parameter, public :: PSPIO_FMT_ABINIT_7 = 17
  integer(c_int), parameter, public :: PSPIO_FMT_ABINIT_8 = 18
  integer(c_int), parameter, public :: PSPIO_FMT_ABINIT_9 = 19
  integer(c_int), parameter, public :: PSPIO_FMT_ABINIT_10 = 20
  integer(c_int), parameter, public :: PSPIO_FMT_ABINIT_11 = 21
  integer(c_int), parameter, public :: PSPIO_FMT_ABINIT_17 = 22
