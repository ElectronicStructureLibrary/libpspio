 ...
 * @param[out] b: the b parameter (depends on mesh type)
 */
int pspio_mesh_get_params(const pspio_mesh_t *mesh, double *a, double *b);
 ...
 */
double * pspio_mesh_get_rab_ptr(const pspio_mesh_t *mesh);
