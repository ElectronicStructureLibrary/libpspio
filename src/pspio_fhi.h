/*
 ...
 $Id: pspio_upf.h 253 2012-08-22 13:36:46Z micael $
 */
 ...
 * @return error code
 */
int pspio_fhi_read(FILE * fp, pspio_pspdata_t **psp_data);
 ...
 * @return error code
 */
int pspio_fhi_write(FILE * fp, const pspio_pspdata_t *psp_data);
